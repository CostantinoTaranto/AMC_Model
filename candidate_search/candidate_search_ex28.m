...
%Group 0
mv0_h(1)=88;   %A2 x component
mv0_v(1)=-24;    %A2 y component

mv0_h(2)=88;  %B2 x component
mv0_v(2)=-24;    %B2 y component

mv0_h(3)=102;   %B3 x component
mv0_v(3)=-12;    %B3 y component

%Group 1
mv1_h(1)=103;   %B1 x component
mv1_v(1)=-9;   %B1 y component
