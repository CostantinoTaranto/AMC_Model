...
%Group 0
mv0_h(1)=-256;   %A2 x component
mv0_v(1)=-48;    %A2 y component

mv0_h(2)=-256;   %B2 x component
mv0_v(2)=-48;    %B2 y component

mv0_h(3)=128;   %B3 x component
mv0_v(3)=64;    %B3 y component

%Group 1
mv1_h(1)=128;   %B1 x component
mv1_v(1)=64;   %B1 y component

mv1_h(2)=-160;   %B0 x component
mv1_v(2)=-80;    %B0 y component

%Group 2
mv2_h(1)=145;   %A1 x component
mv2_v(1)=-52;    %A1 y component

mv2_h(2)=139;   %A0 x component
mv2_v(2)=-62;  %A0 y component
