...
%Group 0
mv0_h(1)=68;   %A2 x component
mv0_v(1)=-26;    %A2 y component

mv0_h(2)=68;   %B2 x component
mv0_v(2)=6;    %B2 y component

mv0_h(3)=75;   %B3 x component
mv0_v(3)=1;    %B3 y component

%Group 1
mv1_h(1)=75;   %B1 x component
mv1_v(1)=1;   %B1 y component

mv1_h(2)=64;   %B0 x component
mv1_v(2)=-16;    %B0 y component

%Group 2
mv2_h(1)=88;   %A1 x component
mv2_v(1)=32;    %A1 y component

mv2_h(2)=96;   %A0 x component
mv2_v(2)=32;  %A0 y component
