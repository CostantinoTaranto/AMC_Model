...
%Group 0
mv0_h(1)=-72;   %A2 x component
mv0_v(1)=-24;    %A2 y component

mv0_h(2)=-12;   %B2 x component
mv0_v(2)=0;    %B2 y component

mv0_h(3)=-64;   %B3 x component
mv0_v(3)=-24;    %B3 y component

%Group 1
mv1_h(1)=-64;   %B1 x component
mv1_v(1)=-24;   %B1 y component

mv1_h(2)=-64;   %B0 x component
mv1_v(2)=-24;    %B0 y component
