...
%Group 0
mv0_h(1)=37;   %A2 x component
mv0_v(1)=-6;    %A2 y component

mv0_h(2)=37;  %B2 x component
mv0_v(2)=-6;    %B2 y component

mv0_h(3)=23;   %B3 x component
mv0_v(3)=12;    %B3 y component

%Group 1
mv1_h(1)=23;   %B1 x component
mv1_v(1)=12;   %B1 y component

mv1_h(2)=25;   %B0 x component
mv1_v(2)=-6;    %B0 y component

%Group 2
mv2_h(1)=29;   %A1 x component
