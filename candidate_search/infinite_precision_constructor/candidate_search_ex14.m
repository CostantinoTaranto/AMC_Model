...
%Group 0
mv0_h(1)=-2;   %A2 x component
mv0_v(1)=32;    %A2 y component

mv0_h(2)=12;   %B2 x component
mv0_v(2)=44;    %B2 y component

mv0_h(3)=-5;   %B3 x component
mv0_v(3)=42;    %B3 y component

%Group 1
mv1_h(1)=-90;   %B1 x component
mv1_v(1)=46;   %B1 y component

mv1_h(2)=192;   %B0 x component
mv1_v(2)=-64;    %B0 y component

%Group 2
mv2_h(1)=-5;   %A1 x component
mv2_v(1)=-6;    %A1 y component

mv2_h(2)=-35;   %A0 x component
mv2_v(2)=-2;  %A0 y component
