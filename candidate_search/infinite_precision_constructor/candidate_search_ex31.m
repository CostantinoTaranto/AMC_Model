...
%Group 0
mv0_h(1)=32;   %A2 x component
mv0_v(1)=8;    %A2 y component

mv0_h(2)=32;  %B2 x component
mv0_v(2)=0;    %B2 y component

mv0_h(3)=32;   %B3 x component
mv0_v(3)=8;    %B3 y component

%Group 1
mv1_h(1)=32;   %B1 x component
mv1_v(1)=8;    %B1 y component

mv1_h(2)=32;   %B0 x component
mv1_v(2)=8;     %B0 y component

%Group 2
mv2_h(1)=-32;  %A1 x component
mv2_v(1)=-8;     %A1 y component

mv2_h(2)=32;   %A0 x component
