...
%Group 0
mv0_h(1)=127;   %A2 x component
mv0_v(1)=-63;    %A2 y component

mv0_h(2)=0;   %B2 x component
mv0_v(2)=0;    %B2 y component

mv0_h(3)=0;   %B3 x component
mv0_v(3)=0;    %B3 y component

%Group 1
mv1_h(1)=64;   %B1 x component
mv1_v(1)=-128;   %B1 y component

mv1_h(2)=0;   %B0 x component
mv1_v(2)=0;    %B0 y component

%Group 2
mv2_h(1)=139;   %A1 x component
mv2_v(1)=-135;    %A1 y component

mv2_h(2)=137;   %A0 x component
mv2_v(2)=-127;  %A0 y component
