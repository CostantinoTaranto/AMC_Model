...
%Group 0
mv0_h(1)=20;   %A2 x component
mv0_v(1)=73;    %A2 y component

mv0_h(2)=7;   %B2 x component
mv0_v(2)=77;    %B2 y component
...
mv1_v(1)=80;   %B1 y component

mv1_h(2)=39;   %B0 x component
mv1_v(2)=-20;    %B0 y component

%Group 2
mv2_h(1)=59;   %A1 x component
mv2_v(1)=63;    %A1 y component

mv2_h(2)=72;   %A0 x component
mv2_v(2)=59;  %A0 y component
