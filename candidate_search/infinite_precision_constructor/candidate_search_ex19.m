...
%Group 0
mv0_h(1)=97;   %A2 x component
mv0_v(1)=-2;    %A2 y component

mv0_h(2)=99;   %B2 x component
mv0_v(2)=-2;    %B2 y component

mv0_h(3)=99;   %B3 x component
mv0_v(3)=0;    %B3 y component

%Group 1
mv1_h(1)=83;   %B1 x component
mv1_v(1)=29;   %B1 y component

mv1_h(2)=81;   %B0 x component
mv1_v(2)=39;    %B0 y component

%Group 2
mv2_h(1)=116;   %A1 x component
mv2_v(1)=11;    %A1 y component

mv2_h(2)=116;   %A0 x component
