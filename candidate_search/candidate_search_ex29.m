...
%Group 0
mv0_h(1)=-4;   %A2 x component
mv0_v(1)=-24;    %A2 y component

mv0_h(2)=21;  %B2 x component
mv0_v(2)=5;    %B2 y component

mv0_h(3)=21;   %B3 x component
mv0_v(3)=5;    %B3 y component

%Group 1
mv1_h(1)=25;   %B1 x component
mv1_v(1)=-3;   %B1 y component

mv1_h(2)=32;   %B0 x component
mv1_v(2)=56;    %B0 y component

%Group 2
mv2_h(1)=-4;   %A1 x component
mv2_v(1)=-24;    %A1 y component
