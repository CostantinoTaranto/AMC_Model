...
%Group 0
mv0_h(1)=16;   %A2 x component
mv0_v(1)=-36;    %A2 y component

mv0_h(2)=-3;   %B2 x component
mv0_v(2)=-21;    %B2 y component

mv0_h(3)=-16;   %B3 x component
mv0_v(3)=-4;    %B3 y component

%Group 1
mv1_h(1)=-37;   %B1 x component
mv1_v(1)=-64;   %B1 y component

mv1_h(2)=-21;   %B0 x component
mv1_v(2)=-64;    %B0 y component

%Group 2
mv2_h(1)=-16;   %A1 x component
mv2_v(1)=-68;    %A1 y component

mv2_h(2)=37;   %A0 x component
mv2_v(2)=-197;  %A0 y component
