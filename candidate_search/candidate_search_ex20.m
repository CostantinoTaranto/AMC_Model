...
%Group 0
mv0_h(1)=24;   %A2 x component
mv0_v(1)=-4;    %A2 y component

mv0_h(2)=24;   %B2 x component
mv0_v(2)=-4;    %B2 y component

mv0_h(3)=24;   %B3 x component
mv0_v(3)=-4;    %B3 y component

%Group 1
mv1_h(1)=118;   %B1 x component
mv1_v(1)=17;   %B1 y component

mv1_h(2)=0;   %B0 x component
mv1_v(2)=0;    %B0 y component

%Group 2
mv2_h(1)=22;   %A1 x component
mv2_v(1)=-3;    %A1 y component

mv2_h(2)=22;   %A0 x component
mv2_v(2)=-3;  %A0 y component
