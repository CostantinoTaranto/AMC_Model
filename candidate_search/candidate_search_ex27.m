...
mv0_h(2)=97;  %B2 x component
mv0_v(2)=-1;    %B2 y component

mv0_h(3)=97;   %B3 x component
mv0_v(3)=15;    %B3 y component

%Group 1
mv1_h(1)=-64;   %B1 x component
mv1_v(1)=-40;   %B1 y component

mv1_h(2)=-96;   %B0 x component
mv1_v(2)=-32;    %B0 y component

%Group 2
mv2_h(1)=98;   %A1 x component
mv2_v(1)=-7;    %A1 y component

mv2_h(2)=98;   %A0 x component
mv2_v(2)=-7;  %A0 y component
